# Brief for a Director of Children's Services

**Workforce instability and outcomes, 2017 to 2025**

Agency reliance peaked in 2023 at
19.3 per cent of the children's social work
workforce and has fallen to 14.8 per cent.
The gap between regions has not closed.

Workforce instability does not predict an Ofsted downgrade. Across
153 authorities and 24 downgrades, no measure of
...
the agency rate is followed by a 0.10 point rise
in re-referrals the next year.

66 authorities form a persistently unstable group. They
are less deprived than the rest, so instability is not a deprivation story.

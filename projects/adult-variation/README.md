# Adult social care variation between local authorities
...
86.7, so councils vary roughly 87 times
...
The care workforce vacancy rate cannot be separated from no effect. Vacancy pressure is often
